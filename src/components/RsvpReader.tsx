  ...
  const renderWords = () => {
    ...
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1.5rem', width: '100%' }}>
        <div style={{ flex: 1, textAlign: 'right', fontSize: '2rem', color: 'var(--text-muted)', opacity: 0.5, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
          {prevWord}
        </div>
        
        <div style={{ display: 'flex', justifyContent: 'center', fontSize: '3rem', fontWeight: 600, letterSpacing: '0.05em', minWidth: '300px' }}>
        ...
        <div style={{ flex: 1, textAlign: 'left', fontSize: '2rem', color: 'var(--text-muted)', opacity: 0.5, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
          {nextWord}
        </div>
      </div>
    );
